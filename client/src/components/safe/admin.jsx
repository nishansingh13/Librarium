    ...
    return (
        ...
        <>
            ...
            <div className='grid grid-cols-3 gap-[10rem]'> 
                <div className='bg-pink-50  h-[100px] grid grid-cols-2'>
                <div>pic</div>
                    <div>Total Users: {totalUsers}</div>
                   
                    </div>
                {console.log(totalUsers)}
                <div>Total Rented: {totalRented}</div>
            ...
            <input
                ...
                value={searchTerm}
                className=' border border-gray-500 outline-gray-200 px-4'
                onChange={handleSearch}
            />
            <button onClick={addBook} className='border  m-2 px-3 bg-[#282E48] text-white rounded-sm mr-[5rem]'>Add Book</button>
