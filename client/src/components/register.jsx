    ...
    return (
        <div className="bg-[#282E48] min-h-screen flex items-center justify-center">
            <div className="w-[25rem] h-auto bg-white mx-auto relative rounded-md p-6">
                ...
                <div className="flex items-center justify-center mb-3 relative right-[1.5rem]">
                    <img src={fb} alt="Facebook" className="rounded-full w-[2rem] h-[2rem] bg-white p-2 mr-4 relative left-[5rem]" />
                    <button
                        type="button"
                ...
                <div className="flex items-center justify-center relative right-[1.5rem]">
                <img src={google} alt="Google" className="rounded-full w-[2rem] h-[2rem] bg-white p-2 mr-4 relative left-[5rem]" />
                    <button
                        type="button"
